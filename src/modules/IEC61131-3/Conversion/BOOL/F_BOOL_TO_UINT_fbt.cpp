...
const CStringDictionary::TStringId FORTE_F_BOOL_TO_UINT::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_F_BOOL_TO_UINT::scmEventOutputTypeIds[] = {STRID(Event)};
...
FORTE_F_BOOL_TO_UINT::FORTE_F_BOOL_TO_UINT(CStringDictionary::TStringId paInstanceNameId,
...
void FORTE_F_BOOL_TO_UINT::executeEvent(TEventID paEIID, CEventChainExecutionThread *const paECET) {
  switch (paEIID) {
...
void FORTE_F_BOOL_TO_UINT::readInputData(TEventID paEIID) {
  switch (paEIID) {
    case scmEventREQID: {
...
void FORTE_F_BOOL_TO_UINT::writeOutputData(TEventID paEIID) {
  switch (paEIID) {
    case scmEventCNFID: {
...
CIEC_ANY *FORTE_F_BOOL_TO_UINT::getDI(size_t paIndex) {
  switch (paIndex) {
...
CIEC_ANY *FORTE_F_BOOL_TO_UINT::getDO(size_t paIndex) {
  switch (paIndex) {
...
CEventConnection *FORTE_F_BOOL_TO_UINT::getEOConUnchecked(TPortId paIndex) {
  switch (paIndex) {
...
CDataConnection **FORTE_F_BOOL_TO_UINT::getDIConUnchecked(TPortId paIndex) {
  switch (paIndex) {
...
CDataConnection *FORTE_F_BOOL_TO_UINT::getDOConUnchecked(TPortId paIndex) {
  switch (paIndex) {
