...
DEFINE_FIRMWARE_FB(FORTE_FB_CTD_ULINT, STRID(FB_CTD_ULINT))

const CStringDictionary::TStringId FORTE_FB_CTD_ULINT::scmDataInputNames[] = {STRID(CD), STRID(LD), STRID(PV)};

const CStringDictionary::TStringId FORTE_FB_CTD_ULINT::scmDataInputTypeIds[] = {STRID(BOOL), STRID(BOOL), STRID(ULINT)};

const CStringDictionary::TStringId FORTE_FB_CTD_ULINT::scmDataOutputNames[] = {STRID(Q), STRID(CV)};

const CStringDictionary::TStringId FORTE_FB_CTD_ULINT::scmDataOutputTypeIds[] = {STRID(BOOL), STRID(ULINT)};
...
const CStringDictionary::TStringId FORTE_FB_CTD_ULINT::scmEventInputNames[] = {STRID(REQ)};
const CStringDictionary::TStringId FORTE_FB_CTD_ULINT::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_FB_CTD_ULINT::scmEventOutputNames[] = {STRID(CNF)};
const CStringDictionary::TStringId FORTE_FB_CTD_ULINT::scmEventOutputTypeIds[] = {STRID(Event)};

const SFBInterfaceSpec FORTE_FB_CTD_ULINT::scmFBInterfaceSpec = {1,
                                                                 scmEventInputNames,
...
FORTE_FB_CTD_ULINT::FORTE_FB_CTD_ULINT(CStringDictionary::TStringId paInstanceNameId,
...
void FORTE_FB_CTD_ULINT::alg_REQ(void) {
  ...
  if (var_LD) {
    var_CV = var_PV;
                                 ...
                                 func_GT(var_CV, CIEC_ULINT(std::numeric_limits<CIEC_ULINT::TValueType>::min())))) {
    var_CV = func_SUB<CIEC_ULINT>(var_CV, CIEC_ULINT(1));
  }
  var_Q = func_LE(var_CV, CIEC_ULINT(0));
}

void FORTE_FB_CTD_ULINT::executeEvent(TEventID paEIID, CEventChainExecutionThread *const paECET) {
  switch (paEIID) {
