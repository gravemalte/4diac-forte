...
const CStringDictionary::TStringId FORTE_FB_CTUD::scmDataOutputTypeIds[] = {STRID(BOOL), STRID(BOOL), STRID(INT)};

const TDataIOID FORTE_FB_CTUD::scmEIWith[] = {0, 1, 2, 3, 4, scmWithListDelimiter};
const TForteInt16 FORTE_FB_CTUD::scmEIWithIndexes[] = {0};
const CStringDictionary::TStringId FORTE_FB_CTUD::scmEventInputNames[] = {STRID(REQ)};
const CStringDictionary::TStringId FORTE_FB_CTUD::scmEventInputTypeIds[] = {STRID(Event)};
