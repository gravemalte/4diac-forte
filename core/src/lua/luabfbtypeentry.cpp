...
bool CLuaBFBTypeEntry::initInternalVarsInformation(SInternalVarsInformation &paInternalVarsInformation,
                                                   CLuaEngine *paLuaEngine,
                                                   int paIndex) {
  paInternalVarsInformation.mNumIntVars =
