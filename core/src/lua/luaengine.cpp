...
bool CLuaEngine::loadString(const std::string &paStr) {
  ...
  if (err) {
    switch (err) {
      case LUA_ERRSYNTAX: DEVLOG_ERROR("Syntax error loading Lua definitions\n"); break;
      case LUA_ERRMEM: DEVLOG_ERROR("Allocation error loading Lua definitions\n"); break;
      default: DEVLOG_ERROR("Unknown error loading Lua definitions\n");
    }
    return false;
  }
  if (!call(0, 1)) {
...
bool CLuaEngine::call(int paArgs, int paResults) {
  ...
  if (err) {
    switch (err) {
      case LUA_ERRRUN: DEVLOG_ERROR("Runtime error calling Lua function: %s\n", lua_tostring(luaState, -1)); break;
      case LUA_ERRMEM: DEVLOG_ERROR("Memory allocation error calling Lua function\n"); break;
      case LUA_ERRERR: DEVLOG_ERROR("Message handler error calling Lua function\n"); break;
      default: DEVLOG_ERROR("Unknown error calling Lua function\n");
    }
    return false;
  }
  return true;
...
bool CLuaEngine::luaPushAny(lua_State *paLuaState, const CIEC_ANY &paValue) {
  ...
  switch (paValue.getDataTypeID()) {
    case CIEC_ANY::e_BOOL: lua_pushboolean(paLuaState, static_cast<const CIEC_BOOL &>(paValue).operator bool()); break;
    ...
    case CIEC_ANY::e_LINT:
      lua_pushinteger(paLuaState,
                      static_cast<lua_Integer>(static_cast<const CIEC_LINT &>(paValue).operator TForteInt64()));
      break;
    ...
    case CIEC_ANY::e_ULINT:
      lua_pushinteger(paLuaState,
                      static_cast<lua_Integer>(static_cast<const CIEC_ULINT &>(paValue).operator TForteUInt64()));
      break;
    ...
    case CIEC_ANY::e_DATE:
      lua_pushinteger(paLuaState,
                      static_cast<lua_Integer>(static_cast<const CIEC_DATE &>(paValue).operator TForteUInt64()));
      break;
    case CIEC_ANY::e_TIME_OF_DAY:
      lua_pushinteger(paLuaState,
                      static_cast<lua_Integer>(static_cast<const CIEC_TIME_OF_DAY &>(paValue).operator TForteUInt64()));
      break;
    case CIEC_ANY::e_DATE_AND_TIME:
      lua_pushinteger(paLuaState, static_cast<lua_Integer>(
                                      static_cast<const CIEC_DATE_AND_TIME &>(paValue).operator TForteUInt64()));
      break;
    case CIEC_ANY::e_TIME:
      lua_pushinteger(paLuaState,
                      static_cast<lua_Integer>(static_cast<TForteInt64>(static_cast<const CIEC_TIME &>(paValue))));
      break;
    ...
    case CIEC_ANY::e_LREAL:
      ...
      break;
    case CIEC_ANY::e_STRING: lua_pushstring(paLuaState, static_cast<const CIEC_STRING &>(paValue).c_str()); break;
    case CIEC_ANY::e_WSTRING: lua_pushstring(paLuaState, static_cast<const CIEC_WSTRING &>(paValue).getValue()); break;
    case CIEC_ANY::e_ARRAY: return luaPushArray(paLuaState, static_cast<const CIEC_ARRAY &>(paValue));
    default:
...
bool CLuaEngine::luaGetAny(lua_State *paLuaState, CIEC_ANY &paValue, int paIndex) {
  ...
  switch (paValue.getDataTypeID()) {
    ...
    case CIEC_ANY::e_DATE:
      ...
      break;
    case CIEC_ANY::e_TIME_OF_DAY:
      static_cast<CIEC_TIME_OF_DAY &>(paValue) =
          CIEC_TIME_OF_DAY(static_cast<TForteUInt64>(lua_tointeger(paLuaState, paIndex)));
      break;
    case CIEC_ANY::e_DATE_AND_TIME:
      static_cast<CIEC_DATE_AND_TIME &>(paValue) =
          CIEC_DATE_AND_TIME(static_cast<TForteUInt64>(lua_tointeger(paLuaState, paIndex)));
      break;
    case CIEC_ANY::e_TIME:
    ...
    case CIEC_ANY::e_WSTRING:
      ...
      break;
    case CIEC_ANY::e_ARRAY: return luaGetArray(paLuaState, static_cast<CIEC_ARRAY &>(paValue), paIndex);
    default:
